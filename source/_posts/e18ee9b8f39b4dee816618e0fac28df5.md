...
> **WARNING** on the video: Do not steal code written specifically for the CS7641 course (eg: ChedCode), steal anything else, some egs: how to implement Decision Tree in sklearn, how to make a line/bar/scatter-plot, how to use pandas, you get the idea.
...
*Library to use* : [mlrose-hiive lib](https://github.com/hiive/mlrose) | [mlrose “non-hiive” outdated docs](https://mlrose.readthedocs.io)
